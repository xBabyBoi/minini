...
/*   Updated: 2025/07/15 21:28:55 by yel-qori         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void					process_operator(char *input, char *result, int *i,
							int *j);
void					copy_single_operator(char *input, char *result, int *i,
							int *j);
void					copy_double_operator(char *input, char *result, int *i,
							int *j);
...
char					**create_new_token_array(char **tokens,
							char *merged_token, int start, int end);
int						calculate_merged_length(char **tokens, int start,
							int end);
...
t_tree					*handle_heredoc_redirection(t_tree *root, int *in,
							char **env);
...
int						handle_redirection_skip(int i, int end, char **cmd_args,
							int arg_count);
t_tree					*handle_redirection_token(t_tree *root, char **tokens,
							int *i, int end);
int						is_complete_quoted_token(char *token);
int						find_token_end(char *input, int i, char *quote,
							int *quote_type);
char					*create_token(char *input, int start, int len,
							t_token_ctx *ctx);
